...
<div class="card"  style="background-color: aliceblue; border:none;">
  <div class="card-body">
    <h6 class="card-title">Customer Call All</h6>
        ...
        <div class="modal-body">
            <form id="myForm" method="POST" action="{{ route('store.customercalls')}}" class="forms-sample" >
                ...
                <div class="mb-3 form-group" >
                    ...
                    <select class="js-example-basic-single form-select select2-hidden-accessible" style="color:black;" name="call_type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
                ...
                <div class="mb-3 form-group" >
                    ...
                    <select class="js-example-basic-single form-select select2-hidden-accessible" style="color:black;" name="status" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
