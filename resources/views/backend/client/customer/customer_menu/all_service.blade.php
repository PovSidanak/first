...
<div class="card"  style="background-color: aliceblue; border:none;">
  <div class="card-body">
    <h6 class="card-title">Customer Service All</h6>
    ...
    <div class="modal-dialog">
      <div class="modal-content"  style="background-color: aliceblue;">
        ...
        <div class="modal-body">
            <form id="myForm" method="POST" action="{{ route('store.customerservice')}}" class="forms-sample" >
                @csrf
                ...
                <div class="mb-3 form-group" >
                    ...
                    <input type="text" name="customer_designation" class="form-control" style="color: black;background-color:aliceblue">
                </div>
                <div class="mb-3 form-group" >
