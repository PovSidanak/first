                        ...
                        <form id="myForm" method="POST" action="{{ route('update.atms',$atms->id)}}" class="forms-sample" >
                          @csrf
                            <div class="mb-3 form-group" >
                                ...
                                <input type="text" name="name" class="form-control" style="color: black;background-color:aliceblue"  value="{{$atms->name }}">
                            </div>
                            <div class="mb-3 form-group" >
                                <label  class="form-label" style="color: gray;">ATM Model</label>
                                <select class="js-example-basic-single form-select select2-hidden-accessible" name="model" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true"  value="{{ $atms->model  }}">
                            ...
                            <div class="mb-3 form-group" >
                              ...
                              <select class="js-example-basic-single form-select select2-hidden-accessible" name="classification" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true"  value="{{$atms->classification  }}">
                          ...
                          <div class="mb-3 form-group" >
                              ...
                              <select class="js-example-basic-single form-select select2-hidden-accessible" name="type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true"  value="{{$atms->type}}">
                          ...
                          <div class="mb-3 form-group" >
                              ...
                              <select class="js-example-basic-single form-select select2-hidden-accessible" name="category" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true"  value="{{ $atms->category}}">
                          ...
                          <div class="mb-3 form-group" >
                              ...
                              <input type="text" name="address" class="form-control" style="color: black;background-color:aliceblue" name="address" value="{{ $atms->address  }}">
                          </div>
                          <div class="mb-3 form-group" >
                              <label  class="form-label" style="color: gray;">City</label>
                              <select class="js-example-basic-single form-select select2-hidden-accessible" name="city" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true"  value="{{$atms->city  }}">
