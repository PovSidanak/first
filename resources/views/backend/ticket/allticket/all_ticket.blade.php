        ...
        <div class="modal-body">
            <form id="myForm" method="POST" action="{{ route('store.tickets')}}" class="forms-sample" >
                ...
                <div class="mb-3 form-group" >
                    ...
                    <input type="text" name="source" class="form-control" style="color: black;background-color:aliceblue">
                </div>
                <div class="mb-3 form-group" >
                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Phone</label>
                    <input type="phone" name="phone" class="form-control" style="color: black;background-color:aliceblue">
                </div>
                  <div class="mb-3 form-group" >
                      <label  class="form-label" style="color: gray;">Call Type</label>
                      <select class="js-example-basic-single form-select select2-hidden-accessible" name="call_type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
                ...
                <div class="mb-3 form-group" >
                    ...
                    <input type="date" name="call_date" class="form-control" style="color: black;background-color:aliceblue">
                </div>
                <div class="mb-3 form-group" >
                    <label  class="form-label" style="color: gray;">Status</label>
                    <select class="js-example-basic-single form-select select2-hidden-accessible" name="status" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
                ...
                <div class="mb-3 form-group" >
                    ...
                    <select class="js-example-basic-single form-select select2-hidden-accessible" name="sub_call_type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
                ...
                <div class="mb-3 form-group" >
                    ...
                    <input type="text" name="diagnoise" class="form-control" style="color: black;background-color:aliceblue">
                </div>
                <div class="mb-3 form-group" >
                    <label  class="form-label" style="color: gray;">Vendor</label>
                    <select class="js-example-basic-single form-select select2-hidden-accessible" name="vendor" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
                ...
                <div class="mb-3 form-group" >
                    ...
                    <select name="users_id" style="background-color: aliceblue; color:black" class="form-select" id="exampleFormControlSelect1">
