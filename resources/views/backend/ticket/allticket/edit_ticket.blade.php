                    ...
                    <h6 class="card-title" style="color: black;">Edit ATM</h6>
                        ...
                        <form id="myForm" method="POST" action="{{ route('update.tickets',$tickets->id)}}" class="forms-sample" >
                          ...
                          <div class="mb-3 form-group" >
                            <label for="exampleInputEmail1" style="color: gray;" class="form-label">ATM Name</label>
                            <select name="a_t_m_s_id" style="background-color: aliceblue; color:black" class="form-select" id="exampleFormControlSelect1">
                               @foreach ($atms as $atm)
                        ...
                        <div class="mb-3 form-group" >
                            <label for="exampleInputEmail1" class="form-label" style="color: gray;">Source</label>
                            <input type="text" name="source" class="form-control" style="color: black;background-color:aliceblue" value="{{ $tickets->source}}">
                        </div>
                        <div class="mb-3 form-group" >
                            <label for="exampleInputEmail1" class="form-label" style="color: gray;">Phone</label>
                            <input type="phone" name="phone" class="form-control" style="color: black;background-color:aliceblue" value="{{ $tickets->phone}}">
                        </div>
                          <div class="mb-3 form-group" >
                              <label  class="form-label" style="color: gray;">Call Type</label>
                              <select class="js-example-basic-single form-select select2-hidden-accessible" name="call_type" style="background-color: aliceblue; color:black" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{ $tickets->call_type}}">
                          ...
                          <div class="mb-3 form-group" >
                            <label for="exampleInputEmail1" class="form-label" style="color: gray;">Call Date</label>
                            <input type="date" name="call_date" class="form-control" style="color: black;background-color:aliceblue" value="{{ $tickets->call_date}}">
                        </div>
                        <div class="mb-3 form-group" >
                            <label  class="form-label" style="color: gray;">Status</label>
                            <select class="js-example-basic-single form-select select2-hidden-accessible" name="status" style="background-color: aliceblue; color:black" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{ $tickets->status}}">
                        ...
                        <div class="mb-3 form-group" >
                            <label  class="form-label" style="color: gray;">Sub Call Type</label>
                            <select style="background-color: aliceblue; color:black" class="js-example-basic-single form-select select2-hidden-accessible" name="sub_call_type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{ $tickets->sub_call_type}}">
                        ...
                        <div class="mb-3 form-group" >
                            <label for="exampleInputEmail1" class="form-label" style="color: gray;">Diagnoise</label>
                            <input type="text" name="diagnoise" class="form-control" style="color: black;background-color:aliceblue" value="{{ $tickets->diagnoise}}">
                        </div>
                        <div class="mb-3 form-group" >
                            <label  class="form-label" style="color: gray;">Vendor</label>
                            <select style="background-color: aliceblue; color:black" class="js-example-basic-single form-select select2-hidden-accessible" name="vendor" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{ $tickets->vendor}}">
                        ...
                        <div class="mb-3 form-group" >
                            ...
                            <select name="users_id" style="background-color: aliceblue; color:black" class="form-select" id="exampleFormControlSelect1" value="{{ $tickets->users_id}}">
                        ...
                        <div class="mb-3 form-group" >
                            ...
                            <input type="text" name="address" class="form-control" style="color: black;background-color:aliceblue" value="{{ $tickets->address}}">
                        </div>
                          <div class="mb-3 form-group" >
                              <label  class="form-label" style="color: gray;">City</label>
                              <select style="background-color: aliceblue; color:black" class="js-example-basic-single form-select select2-hidden-accessible" name="city" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true"  value="{{$tickets->city  }}">
