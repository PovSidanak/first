...
<div class="card" style="background-color: aliceblue; border:none;">
  <div class="card-body">
    <h6 class="card-title">Technical Report All</h6>
        ...
        <div class="modal-body">
            <form id="myForm" method="POST" action="{{ route('store.techniclereports')}}" class="forms-sample" >
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Case Date *</label>
                        <input type="date" name="case_date" class="form-control" style="color: black;background-color:aliceblue" required>
                    </div>
                </div>
                <div class="mb-3 form-group" >
                    <label for="exampleInputEmail1" style="color: gray;" class="form-label">Report Type *</label>
                ...
                <div class="mb-3 form-group" >
                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Upload File *</label>
